...
void benchmark_async_mt(int iterations) {
    ...
    auto logger = minispdlog::async_file_mt(
        "bench_async_block",
        "logs/mini_async_block.log",
        true,
...
int main() {
    ...
    const int SINGLE_ITERATIONS = 100;
    const int MULTI_THREADS = 100;
   // const int MULTI_THREADS = 16;
   // const int MULTI_MESSAGES = 62500;
    const int MULTI_MESSAGES = 5;
